...
class StateEstimator:
    ...
    def pinv_sparse_vmodes(self, a, rcond):
        """
        ...
        res = np.matmul(
            ...
            np.multiply(
                s[self.ofc_data.sparse_modes, np.newaxis],
    ...
    def dof_state(
        ...
        pinv_sensitivity_matrix = self.pinv_sparse_vmodes(
            sensitivity_matrix, rcond=self.rcond
        )
